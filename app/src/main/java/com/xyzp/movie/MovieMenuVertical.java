...
public class MovieMenuVertical implements PopupMenu.OnMenuItemClickListener {
    private final PlayerVerticalActivity playerActivity;
    ...
    public MovieMenuVertical(PlayerVerticalActivity playerActivity, ExoPlayer player, int checkedItem, List<Video> list, Set<TrackGroup> audioSet, Set<TrackGroup> subtitleSet, DefaultTrackSelector trackSelector) {
